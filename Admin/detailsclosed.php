...
<div class='container my-4'>
        ...
        <form action="closed.php" method=post class="btn btn-outline-light">
            <input type="hidden" value='.$sl.' name="sl">
            <input type="submit" name="Reject" value="Mark as rejected" class="btn btn-outline-danger">
        </form>
        </div>';
        }
        if ($stat!='Completed'){
        ...
        <form action="closed.php" method=post class="btn btn-outline-light">
            <input type="hidden" value='.$sl.' name="sl">
            <input type="submit" name="Completed" value="Mark as Completed" class="btn btn-outline-info">
        </form>
        </div>';
        }
        ?>
